...
export const NEIGHBORHOOD_CENTROIDS: Record<string, [number, number]> = {
  ...
  "Hipódromo Condesa": [19.4090, -99.1755],
  "Hipódromo, Condesa": [19.4090, -99.1755],
  ...
  "Tizapán San Ángel": [19.3467, -99.1910],
  "Coyoacán": [19.3467, -99.1618],
  "Las Virreyes": [19.4280, -99.2080],
  "Bosque de las Lomas": [19.4230, -99.2400],
  "San Miguel Chapultepec": [19.4020, -99.1870],
