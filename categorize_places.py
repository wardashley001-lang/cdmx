...
# ---------------------------------------------------------------------------
KNOWN_PLACES = {
    # September 2026 batch — 58 places from a fresh Google Takeout export,
    # researched per-place (web search) before landing here.
    "abarrotes delirio": "stores",
    "amorio": "stores",
    "animacura": "stores",
    "asaderos orozco": "mexican",
    "asador neron": "dinner",
    "bar-rica": "wine",
    "baby bar": "bars",
    "balmori roofbar": "bars",
    "barolo": "italian",
    "bikini pizza": "italian",
    "bocado salumeria": "italian",
    "borel": "cafe",
    "canopia": "wine",
    "cueva clothing store": "stores",
    "camaron chido": "seafood",
    "cantina el tejas": "bars",
    "chiquitito cafe": "cafe",
    "diamantina": "bars",
    "dimora nemorino": "bakery",
    "el mekong ទនលេមេគងគ": "dinner",
    "faba": "wine",
    "freddo - condesa": "dessert",
    "green me condesa": "healthy",
    "hank's pizza choza": "italian",
    "half & half": "healthy",
    "joe & the juice roma": "healthy",
    "koti casa condesa - contrast therapy | sauna & cold plunge | masajes": "salons",
    "kura": "japanese",
    "la vista": "bars",
    "la once mil - roma norte": "mexican",
    "la papaya smoothie house": "healthy",
    "madre cafecito - patio": "cafe",
    "maralunga pizza grill & bar": "italian",
    "marika vera": "stores",
    "martinez": "french",
    "motional muse": "stores",
    "oc market": "stores",
    "ojo de agua": "healthy",
    "osteria 8": "italian",
    "puerto prendes mexican": "mexican",
    "quiero gelato": "dessert",
    "quinquela": "contemporary",
    "roselle": "italian",
    "saint": "bakery",
    "selva wine bar": "wine",
    "sin cruda": "wine",
    "sonia trattoria": "italian",
    "taco tasting room": "mexican",
    "tacos los caramelos - condesa": "mexican",
    "vicinato ristorante": "italian",
    "viamonte": "dinner",
    "vintage hoe": "stores",
    "wan wan sakaba": "japanese",
    "yema nuevo leon": "stores",
    "yema roma": "stores",
    "zii ropa": "stores",
    "zoco fresh roma tienda organica": "stores",
    "lagalleteria": "bakery",
...
SKIP_PLACES = {
    ...
    "av nuevo leon 155",
    "av. nuevo leon 206",
    "c. ensenada 114",  # raw address pin, noted "Gallery" — no identifiable standing venue
}
